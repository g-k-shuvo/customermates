...
export const shareThreadOperation: ZodOpenApiOperationObject = {
  ...
  description:
    "Controls whether a conversation appears on the contacts and deals it matches. Conversations are private until shared, so a personal mailbox does not surface on shared records by default.",
  tags: ["mailbox"],
  security: [{ apiKeyAuth: [] }],
  requestParams: {
