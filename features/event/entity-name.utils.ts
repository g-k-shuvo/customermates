...
const entityNameExtractors: {
  ...
  [DomainEvent.AUTOMATION_CREATED]: (eventData) => eventData.payload.name,
  [DomainEvent.AUTOMATION_UPDATED]: (eventData) => eventData.payload.name,
  [DomainEvent.AUTOMATION_DELETED]: (eventData) => eventData.payload.name,
