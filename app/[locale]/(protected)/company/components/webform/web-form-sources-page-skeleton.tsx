...
export function WebFormSourcesPageSkeleton({ animated = true, view = "table" }: Props) {
  const spec: DataViewSkeletonSpec = view === "table" ? { tableVariant: "entity", view } : { identity: "text", view };

  return <DataViewSkeleton data-web-form-sources-page-skeleton animated={animated} spec={spec} />;
}
